 ...
 *
 * Touch is remapped independently: this module's digitizer is mirrored vs
 * the LVGL logical frame after MADCTL MX. Flip BOARD_TOUCH_MIRROR_* if a
 * unit still mismatches.
 */
